...
class TreeAnalyzerNumpyMMT( Analyzer ):
    """Base TreeAnalyzerNumpyMMT, to create flat TTrees.
    ...
    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(TreeAnalyzerNumpyMMT,self).__init__(cfg_ana, cfg_comp, looperName)
    ...
    def declareVariables(self):
        print 'TreeAnalyzerNumpyMMT.declareVariables : overload this function.'
        pass

    def write(self):
        super(TreeAnalyzerNumpyMMT, self).write()
        self.file.Write() 
