...
#        for ii, it in enumerate(event.triggerObject):
#            for a in it.getSelectionNames():
#                print 'CHECK', ii, ' : ', a
...
##            self.printTriggerObject( event.triggerObject )
        ...
        # import pdb; pdb.set_trace()
        _usePrescaled_ = False
        if hasattr( self.cfg_ana, 'usePrescaled'):
            _usePrescaled_ = self.cfg_ana.usePrescaled
