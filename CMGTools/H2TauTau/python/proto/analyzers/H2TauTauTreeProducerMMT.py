import math, os
from CMGTools.RootTools.analyzers.TreeAnalyzerNumpyMMT import TreeAnalyzerNumpyMMT
...
class H2TauTauTreeProducerMMT( TreeAnalyzerNumpyMMT):
    ...
    def declareHandles(self):
        super(H2TauTauTreeProducerMMT, self).declareHandles()
